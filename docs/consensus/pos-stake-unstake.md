...
This guide goes into detail on how to set up a Proof of Stake network with the Indrachain, how to stake funds for nodes
...
The repo for the Staking Smart Contract is located [here](https://github.com/RavenspiritMedia/staking-contracts.git).
...
Setting up a network with the Indrachain is covered in
the [Local Setup](/docs/get-started/set-up-ibft-locally)
...
the [Staking Smart Contract repo](https://github.com/RavenspiritMedia/staking-contracts.git).
