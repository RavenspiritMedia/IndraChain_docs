...
Please make sure the accounts have enough native tokens to create transactions before starting. In Indrachain, you can assign premined balances to accounts when generating the genesis block.
