...
This is something that is present in almost all parts of the Indrachain. Below, you will find a brief overview of the
built architecture and its layering.

## Indrachain Layering

![Indrachain Architecture](/img/Architecture.jpg)

## Libp2p

It all starts at the base networking layer, which utilizes **libp2p**. We decided to go with this technology because it
fits into the designing philosophies of Indrachain. Libp2p is:
...
Indrachain is designed to offer off-the-shelf pluggable consensus algorithms.
...
## Blockchain
The Blockchain layer is the central layer that coordinates everything in the Indrachain system. It is covered in depth in the corresponding *Modules* section.
