...
This enables the Indrachain to get a specific Merkle trie, for a specific point in time. <br />
...
*state/executor.go* includes all the information needed for the Indrachain to decide how a block changes the current
