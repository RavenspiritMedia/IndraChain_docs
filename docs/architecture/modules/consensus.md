...
The Indrachain wants to maintain a state of modularity and pluggability. <br />
...
To start up IBFT, the Indrachain firstly needs to set up the IBFT transport:
...
The messages are meant to be used by validators. The Indrachain then subscribes to the topic and handles messages accordingly.
