...
Unlike clients such as GETH, the Indrachain doesn't use reflection for the encoding.<br />
...
By manually defining these methods, the Indrachain doesn't need to use reflection. In *rlp_marshal.go*, you can find
